            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body" id="accordion-body">
                        <p>De acordo com os nossos <a>Termos de Uso</a> nós não podemos fornecer um reembolso ou
                            compensação. Entretanto, você pode mandar um email para nós avaliarmos a situação e tomarmos
                            uma medida.</p>
                    </div>
                </div>
            </div>
